      ...
      @predictions.each do |prediction|
        ...
        if game.team1_id == prediction.team1_id && game.team2_id == prediction.team2_id && prediction.final == 4
          if prediction.pointsgiven == 2
            ...
            scoreupdate = Poolmembership.find(prediction.poolmembership_id)
            myes = scoreupdate.score + 20
            score5 = scoreupdate
            score5.score = myes
            score5.save
            prediction.pointsgiven = 2
            prediction.teampointsearned = 20
            prediction.save
            game.completed = true
            game.save
          end
        elsif game.team1_id == prediction.team1_id && prediction.final == 4
          if prediction.pointsgiven == 2
          else
            scoreupdate = Poolmembership.find(prediction.poolmembership_id)
            ...
            score5.save
            prediction.pointsgiven = 2
            prediction.teampointsearned = 10
            prediction.save
            game.completed = true
            game.save
          end

        elsif game.team2_id == prediction.team2_id && prediction.final == 4
          if prediction.pointsgiven == 2
          else
            scoreupdate = Poolmembership.find(prediction.poolmembership_id)
            myes = scoreupdate.score + 10
