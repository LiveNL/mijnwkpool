...
Gem::Specification.new do |s|
  ...
  s.homepage = "http://github.com/whitequark/parser"
  s.licenses = ["MIT"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<ast>, ["~> 1.1"])
      s.add_runtime_dependency(%q<slop>, [">= 3.4.5", "~> 3.4"])
      ...
      s.add_dependency(%q<ast>, ["~> 1.1"])
      s.add_dependency(%q<slop>, [">= 3.4.5", "~> 3.4"])
